    ...
    return <>
        <section className="">
            ...
            <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                ...
                {serviceItem(<FiCloud size={25} />, "Cloud Infrastructure", "cloud-infrastructure", "The developers at Sapphire have extensive professional experience with cloud infrastructure. With us on your team, now you do too.")}
                {serviceItem(<TbManualGearbox size={25} />, "App Integrations", "app-integrations", "App integrations can add new functionality to your new or existing architecture. From payments to texts, we got you covered.")}
                {serviceItem(<GoSearch size={25} />, "Technology Sourcing", "technology-sourcing", "Leverage our expertise in design and development to help shape your web technology going forward. Whether you are evolving or starting fresh.")}
