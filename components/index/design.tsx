        ...
        <section>
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    <AssetCell title="Obsession Over User Experience" src="/svg/user-experience.svg" alt="ux icon" href="/design" desc="Most studies agree upon having 30 seconds to make a good impression on your customers. Software that “feels” as good as it looks is one of the most important parts of development for us, and will make the most impact on your customers having a positive first experience." />
                    <AssetCell title="Crafted Architecture" src="/svg/building.svg" alt="building icon" href="/design" desc="We take “use the right tool for the job not the right job for the tool” to heart. Your unique problems will require unique solutions, and our flexibility in using whatever frameworks or software design that your problems require represents that." />
                    <AssetCell title="Native Experiences" src="/svg/devices.svg" alt="desktop and mobile devices" href="/design" desc="When deciding what tools we will use to build your applications, we give high weight to truly native experiences. We stick to natively compiled mobile applications, Typescript for web development, Swift for Apple ecosystems, and Go or Dart for backend services. These choices enhance the feel and speed of our products exponentially." />
                </div>
            </div>
        </section>
    </>
