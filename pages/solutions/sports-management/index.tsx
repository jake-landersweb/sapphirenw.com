...
const EventManagement = () => {
    return <>
        <Head>
            <title key="title">Sapphire - Sport Management Systems</title>
            <meta name="keywords" id="keywords" content="Sports Management System,Hockey Team Management,Sport Team Management Software,Portland Team Software,Crosscheck,Crosscheck Sports,Custom Sport Website,Custom Sports Apps,Custom Sport Mobile Apps,Sport Mobile Applications" />
        </Head>
        <SolutionsPageWrapper title="Sports Management Software" desc="Sapphire developed the powerful Crosscheck Sports engine. Power your own personal sports team for a fraction of the price." src="/svg/events.svg" alt="Event Schedule Builder" moreTag="#why">
