...
const EventManagement = () => {
    ...
    return <>
        <Head>
            <title key="title">Sapphire - Messaging Systems</title>
        ...
        <SolutionsPageWrapper title="Enterprise Messaging Systems" desc="Touching base with your customers is important. Owning your data is too. Sapphire gives robust tools to do both." src="/svg/mailbox.svg" alt="Mailbox" moreTag="#why">
