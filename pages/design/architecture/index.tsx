...
const Architecture = () => {
    return <>
        <Head>
            <title key="title">Sapphire - Architecture</title>
            <meta name="keywords" id="keywords" content="Native Software Development,Portland Mobile App Development,PNW Native Software,iOS Software,Android Software,Portland Web App Development" />
        </Head>
        <DesignPageWrapper title={"Native Architecture"} desc={"We take “use the right tool for the job not the right job for the tool” to heart. Your unique problems will require unique solutions, and our flexibility in using whatever frameworks or software design that your problems require represents that."}>
